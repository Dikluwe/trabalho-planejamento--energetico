...
energia_base = (
    sum(circuit.Meters.RegisterValues[:1]) if circuit.Meters.First > 0 else 0.0
)
...
print(
    f'  "New CapControl.CC2 element=Line.smt_14449 terminal=1 capacitor=CAP2 type=kvar onsetting={onsetting} offsetting={offsetting}",'
)
